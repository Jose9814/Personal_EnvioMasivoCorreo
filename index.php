    ...
    <nav id="navbar" class="navbar fixed-top navbar-expand-lg navbar-header navbar-mobile">
        <div class="navbar-container container">
            ...
            <div class="collapse navbar-collapse justify-content-around" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link learn-more-btn" href="#" data-toggle="modal" data-target="#modalsuscribete"
    ...
    <div class="wrapper">
        <div class="header">
            <div class="container header-container">
                ...
                <div class="col-lg-5 offset-lg-1 header-title-section">
                    ...
                    <p class="header-title-text">Codelander is a beautifully simple, clean and lightweight landing page
                        template for all types of businesses, with bold and bright colours.</p>
        ...
        <div class="services-section">
            ...
            <div class="container services-container">
                <div class="col-lg-5 services-title-section">
                    ...
                    <p class="services-text">This is a great section to introduce your company and showcase your
                        featured services.</p>
                    <div class="services-accordion">
                        ...
                        <div class="panel">
                            <p>
                                Some information on your web design and development services can go here. A few lines
                                should do the trick.
                            </p>
                        </div>
                        <button class="accordion">
                        ...
                        <div class="panel">
                            <p>
                                More information on your application development services can go here, too. There's
                                plenty of space available for you.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="services-sales-section">
            <div class="container services-container">
                ...
                <div class="col-lg-5 offset-lg-1 services-title-section">
                    ...
                    <p class="services-text">You can talk about your secondary services here, or maybe promote your
                ...
                <div class="blog-posts-section">
                    ...
                    <div class="col-lg-4 col-md-8 col-xs-10 blog-post-card-container">
                        <div class="blog-post-card">
                            ...
                            <p class="blog-post-text mb-4">We've ranked number one on Google for multiple keywords. Read
                                about our SEO strategies</p>
        ...
        <div class="contact-section">
            <div class="container contact-container">
                <div class="col-md-6 contact-title-section">
                    ...
                    <p class="contact-text">We'll be happy to help answer any of your questions. Send us an email and
        ...
        <div class="footer-section">
            ...
            <div class="container footer-credits">
                <p>&copy; 2020 <a href="https://www.codefest.co.uk" target="_blank"
                        title="Codefest">Codefest</a>&trade;. All Rights Reserved.</p>
            </div>
        </div>
    </div>
